...
for (species in BeamanSpeciesList) {
  ...
  BeamanSpeciesFullPeriodTotal <- rbind(BeamanSpeciesFullPeriodTotal, data.frame(Species = species, FullPeriodTotal = BeamanFullPeriodTotal))
}
...
for (species in BellsBendSpeciesList) {
  ...
  # Store the full period total results for the current species
  BellsBendSpeciesFullPeriodTotal <- rbind(BellsBendSpeciesFullPeriodTotal, data.frame(Species = species, FullPeriodTotal = BellsBendFullPeriodTotal))
}
...
for (species in MillCreekSpeciesList) {
  ...
  # Store the full period total results for the current species
  MillCreekSpeciesFullPeriodTotal <- rbind(MillCreekSpeciesFullPeriodTotal, data.frame(Species = species, FullPeriodTotal = MillCreekFullPeriodTotal))
}
...
CombinedParkAttributes <- rbind(BeamanAttributes, BellsBendAttributes, MillCreekAttributes)
