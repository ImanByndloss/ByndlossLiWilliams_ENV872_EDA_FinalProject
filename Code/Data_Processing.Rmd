...
```
```{r}
# REWRITING THE PREVIOUS CODE CHUNK WITH TIDYVERSE
# Create a function to process data for each park
process_species_data <- function(id, camera_dates) {
...
CombinedParks <- rbind(BeamanPark, BellsBendPark, MillCreekPark)
