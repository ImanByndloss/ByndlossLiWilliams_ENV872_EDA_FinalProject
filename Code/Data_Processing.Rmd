...
## Daily Species Data (filtered, adjusted, and totals)
...
class(AllSpeciesData$CountRaw)
class(AllSpeciesData$CountAdjusted)

>>>>>>> 2582bc1 (Checked class of dependent variables.)
```
...
=======
# Combined target park data frames
