...
>For eastern gray squirrel, community and regional parks have statistically different means (p-value < 2.2e-16). The sample estimate for community parks is about 1.82 while the sample estimate for regional parks is 0.201.

>For white-tailed deer, community and regional parks have statistically different means (p-value < 2.2e-16). The sample estimate for community parks is about 0.176 while the sample estimate for regional parks is 0.853.

>For coyote, community and regional parks have statistically the same means (p-value = 0.1471). The sample estimate for community parks is about 0.0363 while the sample estimate for regional parks is about 0.0575.
...
>For eastern gray squirrel, parks less than 1000 acres and parks more than 1000 acres have statistically different means (p-value < 2.2e-16). The sample estimate for parks less than 1000 acres is about 1.00 while the sample estimate for parks more than 1000 acres is 0.215.

>For white-tailed deer, parks less than 1000 acres and parks more than 1000 acres have statistically different means (p-value = 6.312e-07). The sample estimate for parks less than 1000 acres is about 0.754 while the sample estimate for parks more than 1000 acres is 0.374.

>For coyote, parks less than 1000 acres and parks more than 1000 acres have statistically the same means (p-value = 0.1039). The sample estimate for parks less than 1000 acres is about 0.0578 while the sample estimate for parks more than 1000 acres is about 0.0357.
...
>For eastern gray squirrel, parks without disruptive activities and parks with disruptive activities have statistically different means (p-value < 2.2e-16). The sample estimate for parks without disruptive activities is about 1.02 while the sample estimate for parks without disruptive activities is 0.187.

>For white-tailed deer, parks without disruptive activities and parks with disruptive activities have statistically different means (p-value < 2.2e-16). The sample estimate for parks without disruptive activities is about 0.275 while the sample estimate for parks with disruptive activities is 1.33.

>For coyote, parks without disruptive activities and parks with disruptive activities have statistically different means (p-value = 0.04813). The sample estimate for parks without disruptive activities is about 0.0360 while the sample estimate for parks with disruptive activities is about 0.0793.
...
>For eastern gray squirrel, community and regional parks have statistically different means (p-value = 0.004491). The sample estimate for community parks is about 50.7 while the sample estimate for regional parks is 5.58. 

>For white-tailed deer, community and regional parks have statistically different means (p-value = 0.001046). The sample estimate for community parks is about 4.89 while the sample estimate for regional parks is 23.7.

>For coyote, community and regional parks have statistically the same means (p-value = 0.3486). The sample estimate for community parks is about 1.01 while the sample estimate for regional parks is about 1.60.
...
>For eastern gray squirrel, parks less than 1000 acres and parks more than 1000 acres have statistically different means (p-value = 0.01198). The sample estimate for parks less than 1000 acres is about 27.9 while the sample estimate for parks more than 1000 acres is 5.98.

>For white-tailed deer, parks less than 1000 acres and parks more than 1000 acres have statistically the same means (p-value = 0.07912). The sample estimate for parks less than 1000 acres is about 21.0 while the sample estimate for parks more than 1000 acres is 10.4.

>For coyote, parks less than 1000 acres and parks more than 1000 acres have statistically the same means (p-value = 0.252). The sample estimate for parks less than 1000 acres is about 1.61 while the sample estimate for parks more than 1000 acres is about 0.992.
...
>For eastern gray squirrel, parks without disruptive activities and parks with disruptive activities have statistically different means (p-value = 0.008249). The sample estimate for parks without disruptive activities is about 28.3 while the sample estimate for parks without disruptive activities is 5.19.

>For white-tailed deer, parks without disruptive activities and parks with disruptive activities have statistically different means (p-value = 0.001368). The sample estimate for parks without disruptive activities is about 7.65 while the sample estimate for parks with disruptive activities is 37.0.

>For coyote, parks without disruptive activities and parks with disruptive activities have statistically the same means (p-value = 0.1408). The sample estimate for parks without disruptive activities is about 1.00 while the sample estimate for parks with disruptive activities is about 2.20.
