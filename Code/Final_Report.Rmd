...
FP.plot
ggsave(filename="Output/FP.plot_data.pdf", plot= FP.plot)
```
...
```{r adjusted counts over time for only squirrel and deer}
...
[GitHub Repository](https://github.com/ImanByndloss/ByndlossLiWilliams_ENV872_EDA_FinalProject.git)
