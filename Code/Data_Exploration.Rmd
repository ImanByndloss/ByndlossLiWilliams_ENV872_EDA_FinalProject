...
```
```{r}
#Deer and Squirrel counts over time
...
ggplot(Deer_Counts, aes(x=Date, y=CountAdjusted)) +
  geom_line(col='red') + facet_wrap(~ ParkName, ncol = 1) + labs(title = "Deer Counts over Time", y = "Species Count") 
```
...
ggplot(Squirrel_Counts, aes(x=Date, y=CountAdjusted)) +
  geom_line(col='blue') + facet_wrap(~ ParkName, ncol = 1) + labs(title = "Squirrel Counts over Time", y = "Species Count")
