...
to spot on camera in a larger area. Deer were significantly more active in smaller parks when looking at daily trends but there was no significant difference with monthly trends, which suggests short term events might have a bigger effect on activity 
level. 

In the future, more data should be taken to see if these trends holds true for 
other years. If there are any major population shifts, changing the amount and 
location of disruptive park activities might be a good way to ensure a safe
